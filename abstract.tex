...
hidden internal representations of the input data\pxm{training data?}. These representations are
typically not a \pxm{direct?} part of the loss function, and thus \pxm{good point follows, can it be elaborated upon in the main body?} are learned with no direct
...
nor maintainers of the machine learning system being aware of it. \pxm{The following point does not yet make sense. Need to understand mediation first.} For instance,
...
identify directions for further exploration. \pxm{Use this paragraph to introduce results and future work, next paragraph can describe the result.} In our first result, we create
...
mortgage decisions \pxm{Who makes these decisions?} in order to investigate potentially problematic use of
...
\pxm{Summarize works again and stipulate what the overall benefits of them will be.}
